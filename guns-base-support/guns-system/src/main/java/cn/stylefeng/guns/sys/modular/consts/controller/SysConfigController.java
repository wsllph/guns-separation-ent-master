...
public class SysConfigController {
     ...
     */
    @Permission
    @GetMapping("/sysConfig/test")
    public HashMap<String, String> selectById(@RequestBody  @Validated(value = BaseEntity.list.class) SysConfig sysConfig){
        HashMap<String, String> selectByIdHashMap = sysConfigService.selectById(sysConfig.getId()+"");
        return selectByIdHashMap;
    }
     ...
     */
    @Permission
    @GetMapping("/sysConfig/test1")
    public HashMap<String, String> selectById1(@NotEmpty(message = "id不能为空") String id){
        HashMap<String, String> selectByIdHashMap = sysConfigService.selectById(id);
        return selectByIdHashMap;
    }
}
