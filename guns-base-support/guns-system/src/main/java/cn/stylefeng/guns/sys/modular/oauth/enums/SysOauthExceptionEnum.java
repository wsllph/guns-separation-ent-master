 ...
 */
package cn.stylefeng.guns.sys.modular.oauth.enums;
 ...
 */
@ExpEnumType(module = SysExpEnumConstant.GUNS_SYS_MODULE_EXP_CODE, kind = SysExpEnumConstant.OAUTH_EXCEPTION_ENUM)
